...
#'
#' @param labelId string ID to match with a call to output$<labelId> in the
#'                       server function of the app.
#'
#' @return object Collection of shiny UI elements
#' @importFrom DT dataTableOutput
#' @importFrom shiny tagList wellPanel fluidRow column
#' @importFrom htmltools div
#' @export
#'
#' @examples
mapSelectHeaderUI <- function(labelId) {
  t <- shiny::tagList(
